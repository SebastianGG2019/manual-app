...
export const data = [
    ...
    {name: 'Configuración',
     contenido:
        <div style={{marginTop: '30px'}}>
            <li>10. Posteriormente veremos una lista de los ítems que están listos para configurar. Damos click en next. </li>
